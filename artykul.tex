...
Postanowienia licencyjne przedstawione są w~punkcie \ref{refmysec:licencja}.
W punkcie \ref{refmysec:techniczne}. zawarto garść szczegółów technicznych.
}
